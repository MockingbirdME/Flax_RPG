let strainsData = {
    denja: {
        ...
        placeInSociety: "Denja can be found in just about any town in Flax, they are social, well liked, and friendly. Denja are rarely ambitious and as such it is uncommon to find them in positions of power unless they have been appointed to them by a member, or members, of another strain.",
        namingConventions: "Denja children are not given names by their parents, or households, instead they are referred to by descriptions or pet names until they reach adulthood and leave the households they were born to. When they do venture out from their household they select a name for themselves. A Denja's chosen name is often a description they wish to strive for, to those who do not speak Denja a shortened version, or simplified translation, if often used.",
        size: -1,
        speed: 3,
        attributeModifiers: {
    ...
    torleni: {
        ...
        placeInSociety: "Toleni are rare outside of The Trail of Eyes, which is populated almost exclusively by them and those members of other strains they've taken as slaves or the Grailic states where they are almost entirely members of the ruling class. Torleni elsewhere are generally mistrusted and feared due to their reputation as slavers and tyrants.",
        namingConventions: "In the Trail of Eyes Torleni tend to have a single given name and occasionally a title or description, in the Grailic states they have a given name, the name of their parent, occasionally a title or description, and a house affiliation and rank.",
        size: 0,
        speed: 0,
        attributeModifiers: {
            description: "",
