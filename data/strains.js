let strainsData = {
  denja: {
    ...
    placeInSociety:
      "Denja can be found in just about any town in Flax, they are social, well liked, and friendly. Denja are rarely ambitious and as such it is uncommon to find them in positions of power unless they have been appointed to them by a member, or members, of another strain.",
    namingConventions:
      "Denja children are not given names by their parents, or households, instead they are referred to by descriptions or pet names until they reach adulthood and leave the households they were born to. When they do venture out from their household they select a name for themselves. A Denja's chosen name is often a description they wish to strive for, to those who do not speak Denja a shortened version, or simplified translation, if often used.",
    size: -1,
    speed: 3,
    attributeModifiers: {
