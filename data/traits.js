const traitsData = {
  ...
  trainingExpert: {
    ...
    keywords: ["Epic"],
    description:
      "The character increases one skill from rank two to rank three."
  },
  heroicAttribute: {
  ...
  dualWeilder: {
    ...
    keywords: ["Simple"],
    description:
      "The character can wield one handed weapons in their off hand and make off handed attacks with them."
  },
  duelist: {
    displayName: "Duelist",
    type: "Combat",
