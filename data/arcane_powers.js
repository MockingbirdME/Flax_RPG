let arcaneEffectsData = {
    ...
    componentsLavishConsumable: {
        ...
        otherLimitation: null,
        description: "casting the spell requires the caster to speak loudly, have both hands free or holding arcane focuses, and to provide arcane components worth at least ???x250 pennies that are consumed by the casting.",
        additionalCost: null
    },
    ...
    componentsSimple: {
        ...
        limitedType: "Consumable",
        otherLimitation: null,
        description: "casting the spell requires the caster to speak at a regular volume and have one hand free or holding an arcane focus, or to speak loudly with both hands occupied, or have both hands free and not speak at all.",
        additionalCost: null
    },
    componentsLimited: {
        ...
        limitedType: "Consumable",
        otherLimitation: null,
        description: "casting the spell requires the caster to speak at a whisper or have one hand free or holding an arcane focus.",
        additionalCost: null
    },
    componentsNone: {
    ...
    durationBasic: {
        ...
        availableForSpells: true,
        limitedType: false,
        otherLimitation: "a caster cannot have more duration effects ongoing at one time than one plus their mind, if positive.",
    ...
    durationExtended: {
        ...
        availableForSpells: true,
        limitedType: false,
        otherLimitation: "a spell, cantrip, or effect must already have a duration effect.",
        description: "the cantrip, spell, or crafted effect lasts for an additional round (if the caster spends stamina to continue the effect it still only lasts for one additional round).",
        additionalCost: "each additional effect doubles the initial duration (one additional cost results in 4 rounds for the initial effect, two additional cost results in 8, etc.)."
    },
    duplicate: {
        ...
        limitedType: false,
        otherLimitation: null,
        description: "two instances of effect are created upon casting, they must be triggered separately.",
        additionalCost: "every additional arcane cost spent on this power increases the number of instances of the effect by one."
    },
    extendedRangeBasic: {
        ...
        additionalCost: "further increase the effect's range and range increment by one hex for every additional arcane cost spend on this effect"
    }
};
